...
# 107 "../src/./USB/usb_function_cdc.h"
# 1 "../src/./USB/usb.h" 1
# 108 "../src/./USB/usb_function_cdc.h" 2
...
# 5 "../src/main.c" 2
# 1 "../src/HardwareProfile.h" 1
# 46 "../src/HardwareProfile.h"
# 1 "../src/HardwareProfile - PIC32MX460F512L PIM.h" 1
# 47 "../src/HardwareProfile.h" 2
# 6 "../src/main.c" 2

# 1 "../src/./Common/Compiler.h" 1
# 8 "../src/main.c" 2
# 1 "../src/USB/usb_config.h" 1
# 9 "../src/main.c" 2
# 1 "../src/USB/usb_device.h" 1
...
char usbkey_buffer[64] ;
char usbkey_ptr=0 ;
char usbkey_fillptr=0 ;
# 81 "../src/main.c"
void* lastTransmission;
...
void ForthUSB() {
  ...
  if((USBDeviceState < CONFIGURED_STATE)||(U1PWRCbits.USUSPEND==1)) return;
 ...
 usbkey_ptr = 0;
   ...
   if ( (64 - usbkey_fillptr) > 0) {
      int cnt=0;

      if ( (cnt = getsUSBUSART(&(usbkey_buffer[usbkey_fillptr]), (64 - usbkey_fillptr) )) != 0) {
         usbkey_fillptr += cnt;
      }
   }
  ...
  usbkey_ptr++;
   ...
   if(((cdc_trf_state == 0)) && (NextUSBOut > 0)) {
