...
# 68 "../src/timer1_int.c" 2
# 87 "../src/timer1_int.c"
void TimerInit(void)
{
# 102 "../src/timer1_int.c"
    (T2CON = (((1 << 0x0000000F) | (0))&~((1 << 0x0000000F))), TMR2 = 0, PR2 = (((40000000L)/38000)), T2CONSET=(((1 << 0x0000000F) | (0))&((1 << 0x0000000F))) );


    ((IFS0CLR = 0x00000200), (IPC2CLR = 0x0000001C, IPC2SET = (((((1 << 15) | (2)) & 7)) << 0x00000002)), (IPC2CLR = 0x00000003, IPC2SET = (((((1 << 15) | (2)) >> 4) & 3) << 0x00000000)), (IEC0CLR = 0x00000200, IEC0SET = ((((1 << 15) | (2)) >> 15) << 0x00000009)));
...
# 160 "../src/timer1_int.c"
void __attribute__((vector(8), interrupt(IPL2SOFT), nomips16)) Timer2Handler(void)
{
...
void __attribute__((vector(19), interrupt(ipl1), nomips16)) Int4Interrupt(void)
{
