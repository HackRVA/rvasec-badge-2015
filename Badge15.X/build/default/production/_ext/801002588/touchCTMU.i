# 1 "/home/paul/rvasec-badge-2015-dev/src/touchCTMU.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/paul/rvasec-badge-2015-dev/src/touchCTMU.c"
...
# 2 "/home/paul/rvasec-badge-2015-dev/src/touchCTMU.c" 2
...
# 3 "/home/paul/rvasec-badge-2015-dev/src/touchCTMU.c" 2
# 1 "/home/paul/rvasec-badge-2015-dev/src/touchCTMU.h" 1
# 4 "/home/paul/rvasec-badge-2015-dev/src/touchCTMU.c" 2





static unsigned short int ButtonADCChannels[4] = {0,1,3,4};
# 18 "/home/paul/rvasec-badge-2015-dev/src/touchCTMU.c"
unsigned short int ButtonVmeasADC[4];

unsigned char Nnops=3;
short int CurrentButtonStatus=0;

void getTouch()
{
    unsigned long int ADC_Sum;
    unsigned short int iAvg,
    ...
    short int iButton,
                       iChan;
    unsigned short int VmeasADC, VavgADC, nops;
    ...
    for ( iButton = 0; iButton < 4; iButton++ )
    {
        ...
        {
            VavgADC = ADC_Sum >> (Log2Naverages-6);
        }
        else
        {
            VavgADC = ADC_Sum << (6-Log2Naverages);
        }
        if ( VavgADC < 32768 )
        {
