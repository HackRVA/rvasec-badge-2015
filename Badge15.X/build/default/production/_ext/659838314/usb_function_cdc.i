# 1 "../src/USB/usb_function_cdc.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../src/USB/usb_function_cdc.c"
# 105 "../src/USB/usb_function_cdc.c"
# 1 "../src/USB/usb.h" 1
# 110 "../src/USB/usb.h"
...
# 131 "../src/USB/usb.h" 2
# 106 "../src/USB/usb_function_cdc.c" 2
# 1 "../src/USB/usb_function_cdc.h" 1
# 617 "../src/USB/usb_function_cdc.h"
void CDCInitEP(void);
# 643 "../src/USB/usb_function_cdc.h"
void USBCheckCDCRequest(void);
# 661 "../src/USB/usb_function_cdc.h"
void CDCNotificationHandler(void);
# 687 "../src/USB/usb_function_cdc.h"
BOOL USBCDCEventHandler(USB_EVENT event, void *pdata, WORD size);
# 734 "../src/USB/usb_function_cdc.h"
BYTE getsUSBUSART(char *buffer, BYTE len);
# 776 "../src/USB/usb_function_cdc.h"
void putUSBUSART(char *data, BYTE Length);
# 817 "../src/USB/usb_function_cdc.h"
void putsUSBUSART(char *data);
# 860 "../src/USB/usb_function_cdc.h"
void putrsUSBUSART(const const char *data);
# 912 "../src/USB/usb_function_cdc.h"
...
# 107 "../src/USB/usb_function_cdc.c" 2
...
# 108 "../src/USB/usb_function_cdc.c" 2
# 187 "../src/USB/usb_function_cdc.c"
volatile unsigned char cdc_data_tx[64] ;
volatile unsigned char cdc_data_rx[64] ;

LINE_CODING line_coding ;
volatile CDC_NOTICE cdc_notice ;
# 201 "../src/USB/usb_function_cdc.c"
BYTE cdc_rx_len;
...
DWORD BaudRateGen;
# 229 "../src/USB/usb_function_cdc.c"
BYTE_VAL dummy_encapsulated_cmd_response[0x08];
...
# 266 "../src/USB/usb_function_cdc.c"
void USBCheckCDCRequest(void)
{
    ...
    if(SetupPkt.RequestType != (0x20>>5)) return;





    if((SetupPkt.bIntfID != 0x0)&&
       (SetupPkt.bIntfID != 0x01)) return;
    ...
    switch(SetupPkt.bRequest)
    {
        ...
        case 0x20:
            ...
            outPipes[0].pDst.bRam = (BYTE*)&cdc_notice.SetLineCoding._byte[0];
            outPipes[0].pFunc = &mySetLineCodingHandler;
            outPipes[0].info.bits.busy = 1;
            break;

        case 0x21:
            { inPipes[0].pSrc.bRam = (BYTE*)&line_coding; inPipes[0].wCount.Val = 0x07; inPipes[0].info.Val = 0x40 | 0x80 | 0x01; }
...
# 350 "../src/USB/usb_function_cdc.c"
            inPipes[0].info.bits.busy = 1;
            break;
# 375 "../src/USB/usb_function_cdc.c"
        default:
            break;
    }

}
# 413 "../src/USB/usb_function_cdc.c"
void CDCInitEP(void)
{

    line_coding.dwDTERate.Val = 19200;
    line_coding.bCharFormat = 0x00;
    line_coding.bParityType = 0x00;
    line_coding.bDataBits = 0x08;

    cdc_rx_len = 0;
# 434 "../src/USB/usb_function_cdc.c"
    USBEnableEndpoint(1,0x04|0x01|0x10);
    USBEnableEndpoint(2,0x04|0x08|0x01|0x10);

    CDCDataOutHandle = USBTransferOnePacket(2,0,(BYTE*)&cdc_data_rx,sizeof(cdc_data_rx));
    CDCDataInHandle = (0L);
# 465 "../src/USB/usb_function_cdc.c"
    cdc_trf_state = 0;
}
# 543 "../src/USB/usb_function_cdc.c"
BOOL USBCDCEventHandler(USB_EVENT event, void *pdata, WORD size)
{
    switch( (INT)event )
    {
...
# 604 "../src/USB/usb_function_cdc.c"
BYTE getsUSBUSART(char *buffer, BYTE len)
{
    cdc_rx_len = 0;

    if(!(CDCDataOutHandle==0?0:((volatile BDT_ENTRY*)CDCDataOutHandle)->STAT.UOWN))
    {




        if(len > (((volatile BDT_ENTRY*)CDCDataOutHandle)->CNT))
            len = (((volatile BDT_ENTRY*)CDCDataOutHandle)->CNT);
...
# 675 "../src/USB/usb_function_cdc.c"
void putUSBUSART(char *data, BYTE length)
{
# 700 "../src/USB/usb_function_cdc.c"
    {IEC1CLR = 0x00000008;};
    if(cdc_trf_state == 0)
    {
        { pCDCSrc.bRam = (BYTE*)data; cdc_tx_len = length; cdc_mem_type = 0x01; cdc_trf_state = 1; };
    }
    {IEC1SET = 0x00000008;};
}
# 748 "../src/USB/usb_function_cdc.c"
void putsUSBUSART(char *data)
{
    BYTE len;
    char *pData;
# 776 "../src/USB/usb_function_cdc.c"
    {IEC1CLR = 0x00000008;};
    if(cdc_trf_state != 0)
    {
        {IEC1SET = 0x00000008;};
    ...
    { pCDCSrc.bRam = (BYTE*)data; cdc_tx_len = len; cdc_mem_type = 0x01; cdc_trf_state = 1; };
    {IEC1SET = 0x00000008;};
}
# 845 "../src/USB/usb_function_cdc.c"
void putrsUSBUSART(const const char *data)
{
    BYTE len;
    const const char *pData;
# 873 "../src/USB/usb_function_cdc.c"
    {IEC1CLR = 0x00000008;};
    if(cdc_trf_state != 0)
    {
        {IEC1SET = 0x00000008;};
...
# 899 "../src/USB/usb_function_cdc.c"
    { pCDCSrc.bRom = (const BYTE*)data; cdc_tx_len = len; cdc_mem_type = 0x00; cdc_trf_state = 1; };
    {IEC1SET = 0x00000008;};

}
# 955 "../src/USB/usb_function_cdc.c"
void CDCTxService(void)
{
    BYTE byte_to_send;
    BYTE i;
    ...
    if((CDCDataInHandle==0?0:((volatile BDT_ENTRY*)CDCDataInHandle)->STAT.UOWN))
    {
        {IEC1SET = 0x00000008;};
        return;
    }
    ...
    if(cdc_trf_state == 2)
    {
        CDCDataInHandle = USBTransferOnePacket(2,1,(0L),0);
    ...
    else if(cdc_trf_state == 1)
    {
     ...
     cdc_tx_len = cdc_tx_len - byte_to_send;
        ...
        pCDCDst.bRam = (BYTE*)&cdc_data_tx;

        i = byte_to_send;
        if(cdc_mem_type == 0x00)
        {
            while(i)
            {
        ...
        CDCDataInHandle = USBTransferOnePacket(2,1,(BYTE*)&cdc_data_tx,byte_to_send);
