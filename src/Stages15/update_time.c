...
void update_time_draw_selction(){
    ...
    if(UPDATE_TIME_IS_DRAWN == 0){
        ...
        {
            y = 10;
            add_to_display_list(CHARACTER,
                                color,
                                10+(UPDATE_TIME_STRING_COUNTER*6),
                                y,
                                badge_time_set[UPDATE_TIME_STRING_COUNTER],
                                0);
        }
        else
        {
            ...
            add_to_display_list(CHARACTER,
                                color,
                                10+(UPDATE_TIME_STRING_COUNTER*6-36),
                                y,
                                badge_date_set[UPDATE_TIME_STRING_COUNTER-6],
                                0);
        }
